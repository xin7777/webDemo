    ...
    <div id="s_fm" class="s_form" >
        ...
        <form name="f" action="https://www.baidu.com/s" class="fm">
            ...
            <span class="s_ipt_wr" onmousedown="this.className='s_ipt_wr iptfocus'"
                ...
                type="submit" id="su" value="Go" class="btn" onmouseover="this.className='btn btn_h'"
                onmousedown="this.className='btn btn_h'" onmouseout="this.className='btn'"></span><span
...
<!--<div id="s_tab" class="s_tab">-->
    <!--<div id="s_tab_wrap">-->
        <!--<div class="crumb"><a href="http://www.baidu.com/">百度首页</a>&nbsp;&nbsp;<span-->
                <!--style="font-family:simsun">&gt;</span>&nbsp;&nbsp;产品大全-->
        <!--</div>-->
    <!--</div>-->
<!--</div>-->
<div id="main">
...
<div class="footer">&copy; 2018 Baidu <a href="http://www.baidu.com/duty/" target="_blank">使用百度前必读</a></div>
...
<script >
    ...
    $("#content")
        .append("<div class=\"con\">\n" +
            "            <div><a href=\"http://bim.baidu.com\" class=\"abg attr_783\" target=\"_blank\"></a></div>\n" +
            "            <div><a href=\"http://bim.baidu.com\" target=\"_blank\">百度营销研究院</a><br/><span>让商业决策更简单</span></div>\n" +
            "        </div>");
    function G(id) {
